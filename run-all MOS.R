...
all.anxiety <- filter(subject_anxiety_2016,sub!=17 & sub!=20 & sub!=28 & sub!=14)
all.coeff <- filter(choice.coeff.DT,subject!=17 & subject!=20 & subject!=28 & subject!=14)
all.regret <- filter(regrets.DT,subject!=17 & subject!=20 & subject!=28 & subject!=14)
...
all.utility <- filter(all.utility,subject!=17 & subject!=20 & subject!=28)
